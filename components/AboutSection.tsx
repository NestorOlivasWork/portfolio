        ...
        <section id="about" className="about-section relative bg-cover bg-center py-20">
            <div className="w-[80%] mx-auto grid lg:grid-cols-2 gap-[3rem] h-full items-start relative z-10">
                ...
                <div className="text-left flex flex-col h-full">
                    ...
                    Hello! I'm Nestor Olivs, a passionate full-stack and blockchain developer, with a strong background in Chikago. 
                        With 9+ years of experience in web developing , I thrive on <b>Web design</b> and <b>Backend engineering</b>.
